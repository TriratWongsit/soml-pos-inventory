...
## 4.6 แดชบอร์ดปฏิบัติการและระดับบริหาร — UC-08, UC-09
...
## 4.7 การแจ้งเตือนภายในแอปพลิเคชัน — UC-11
...
| NFR-06 | ต้องรองรับผู้ใช้งานพร้อมกันไม่น้อยกว่า 10 เซสชันในช่วงเวลาเร่งด่วน | 10 เซสชัน 200 คำขอ ไม่มีคำขอล้มเหลว ตอบสนองเฉลี่ย 7.2 ms | TC-14 |
...
ความครอบคลุมโค้ดของชุดทดสอบอยู่ที่ร้อยละ 82.88 ของคำสั่ง และร้อยละ 85.71 ของบรรทัด สูงกว่าเกณฑ์ร้อยละ 70 ที่กำหนดไว้
...
## B.1 Model Elements and Traceability
...
แบบจำลองทั้งหมดมีแผนภาพประกอบอยู่ในบทที่ 3 ของปริญญานิพนธ์ ได้แก่ แผนภาพบริบทของระบบ แผนภาพคอนเทนเนอร์ แผนภาพส่วนประกอบ แผนภาพความสัมพันธ์ระหว่างข้อมูล แผนภาพกรณีการใช้งานสี่กลุ่ม แผนภาพลำดับของการสร้างคำสั่งซื้อและของการยืนยันจ่ายสินค้า แผนภาพกิจกรรม และแผนภาพสถานะของคำสั่งซื้อ
...
## E.3 Requirement → Verification Result
...
|---|---|---|
| โครงสร้างตามแบบฟอร์ม IEEE ส่วน 1–6 และ Appendix A–C | PASS | คงลำดับหัวข้อตามแบบฟอร์มที่ได้รับ เพิ่ม D–F เพื่อ Traceability และ QA |
...
| UC-01..11 พร้อม Flow ครบ | PASS | ส่วนที่ 4 จัดกลุ่มเป็นแปดหัวข้อครอบคลุมทั้งสิบเอ็ดกรณี |
