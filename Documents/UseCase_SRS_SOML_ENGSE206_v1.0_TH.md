...
| Version | 1.0 |
| สถานะ | Review Candidate — ยังไม่ใช่ Baseline |
...
> เอกสารนี้กำหนดความต้องการของระบบ SOML ก่อนเข้าสู่ขั้นทดสอบ จึงระบุเกณฑ์และวิธีทวนสอบไว้ แต่ยังไม่รายงานผลการทดสอบ ผลการทดสอบจริงอยู่ในบทที่ 4 ของปริญญานิพนธ์ และเอกสารนี้ไม่รวมข้อมูลภายในของสถานประกอบการ เช่น หมายเลขพร้อมเพย์จริงและรหัสผ่านผู้ใช้งานจริง
...
| 1.0 | 2026-09-08 | จัดวางข้อมูลลง IEEE SRS Template พร้อมแบบจำลองและ Traceability | Review Candidate |
...
เอกสาร Use Case SRS ฉบับนี้กำหนดความต้องการซอฟต์แวร์สำหรับระบบ SOML ซึ่งเป็นระบบจัดการคำสั่งซื้อและตรวจสอบคลังสินค้าของร้านวัสดุก่อสร้างอำพรคอนกรีต โดยนำผลจากการสำรวจปัญหาหน้างานและการวิเคราะห์ความต้องการ มาจัดวางในโครงสร้าง SRS เพื่อให้ผู้พัฒนา ผู้ทดสอบ อาจารย์ที่ปรึกษา และเจ้าของสถานประกอบการตรวจสอบขอบเขต พฤติกรรม กฎ แบบจำลอง และ Traceability ร่วมกันได้

เวอร์ชัน 1.0 นี้เป็น Review Candidate ยังไม่ใช่ Baseline เนื่องจากยังมีประเด็นที่ต้องยืนยันกับเจ้าของสถานประกอบการและต้องทวนสอบที่หน้างานจริงตามที่ระบุไว้ใน Appendix C การวางแผนการทดสอบและผลการทดสอบไม่อยู่ในเอกสารฉบับนี้ แต่อยู่ในบทที่ 3 และบทที่ 4 ของปริญญานิพนธ์
...
| ID | เกณฑ์ที่กำหนด | Verification |
|---|---|---|
| NFR-02 | ข้อมูลคำสั่งซื้อใหม่ต้องแสดงบนหน้าจอคิวภายใน 3 วินาที | จับเวลาตั้งแต่ยืนยันรับชำระจนคำสั่งซื้อปรากฏบนหน้าจอคิว วัดซ้ำหลายครั้งแล้วเทียบกับเกณฑ์ |
| NFR-05 | เครื่องพิมพ์ใบเสร็จต้องพิมพ์สำเร็จภายใน 5 วินาทีหลังยืนยันรับชำระ | จับเวลากับเครื่องพิมพ์ความร้อนจริงที่สถานประกอบการ |
| NFR-06 | ต้องรองรับผู้ใช้งานพร้อมกันไม่น้อยกว่า 10 เซสชันในช่วงเวลาเร่งด่วน | จำลองการใช้งานพร้อมกัน 10 เซสชันจากทั้งสามบทบาท แล้วตรวจว่าไม่มีคำขอใดล้มเหลว |

เกณฑ์เวลาข้างต้นมาจากลักษณะการทำงานหน้างาน คือลูกค้าเดินจากจุดชำระเงินไปยังจุดรับของใช้เวลาราวหนึ่งถึงสองนาที ข้อมูลจึงต้องถึงหน้าจอคลังก่อนหน้านั้นมาก ส่วนค่าที่วัดได้จริงจะรายงานในบทที่ 4 ของปริญญานิพนธ์
...
|---|---|---|
| CON-08 | ต้องเข้าถึงผ่าน HTTPS เท่านั้น การเรียกผ่าน http ต้องถูกส่งต่อไปยัง https | เรียกระบบผ่าน http แล้วตรวจว่าถูกส่งต่อไปยัง https |
| NFR-01 | ข้อมูลและเมนูต้องจำกัดการเข้าถึงตามบทบาทอย่างเข้มงวด ทุกคำขอต้องแนบโทเคนและถูกตรวจสิทธิ์ก่อนประมวลผล | เรียกทุกเส้นทางโดยไม่แนบโทเคน แนบโทเคนปลอม และเรียกด้วยบทบาทที่ไม่มีสิทธิ์ |
| NFR-01 | รหัสผ่านต้องเก็บเป็นค่าที่ผ่านการเข้ารหัส ไม่เก็บรหัสผ่านจริง | ตรวจค่าที่จัดเก็บในฐานข้อมูล |
...
| CON-07 | หมายเลขพร้อมเพย์จริงและรหัสผ่านฐานข้อมูลต้องไม่ถูกเก็บลงที่เก็บโค้ด | ตรวจไฟล์ในที่เก็บโค้ดและอ่านรหัส QR ในภาพประกอบทุกภาพ |

## 5.4 Software Quality Attributes

| ID | ด้านคุณภาพ | เกณฑ์ | Verification |
|---|---|---|---|
| NFR-03 | ความใช้ง่าย | หน้าจอคิวและยืนยันจ่ายต้องใช้งานได้บนแท็บเล็ตและสมาร์ตโฟน | เปิดทุกหน้าจอที่ความกว้างของอุปกรณ์เคลื่อนที่แล้วตรวจว่าใช้งานครบทุกปุ่ม |
| NFR-04 | ความเชื่อถือได้ | ฐานข้อมูลต้องทนทานต่อธุรกรรมพร้อมกัน ไม่เกิดสภาวะแข่งขัน | ยิงคำขอยืนยันจ่ายพร้อมกันหลายคำขอต่อคำสั่งซื้อเดียว แล้วตรวจยอดสต็อกและบันทึกการเคลื่อนไหว |
| NFR-07 | ความเข้ากันได้ | ทำงานถูกต้องบน Chrome, Edge และ Firefox รุ่นล่าสุด | เปิดทุกหน้าจอบนเบราว์เซอร์ที่กำหนดและตรวจข้อผิดพลาดในคอนโซล |
| NFR-08 | การบำรุงรักษา | แยกชั้นตามสถาปัตยกรรมสามชั้น และแยกส่วนประกอบตามที่ออกแบบ | ตรวจโครงสร้างซอร์สโค้ดเทียบกับแผนภาพส่วนประกอบ |
| NFR-09 | การพกพา | ติดตั้งซ้ำบนเครื่องใหม่ได้ด้วยเอกสารเพียงอย่างเดียว | ให้ผู้ที่ไม่ได้ร่วมพัฒนาติดตั้งตามคู่มือโดยไม่แก้ซอร์สโค้ด |
| — | Testability | ทุกความต้องการและกฎต้องจับคู่กับเกณฑ์การยอมรับ หรือถูกบันทึกเป็นประเด็นที่ยังไม่ปิด | Appendix D และ Appendix F |
...
| ประเด็น | สถานะ |
|---|---|
| ความต้องการเชิงหน้าที่ FR-01..09 | กำหนดครบทุกข้อ พร้อมกรณีการใช้งานและเกณฑ์การยอมรับ |
| ความต้องการนอกเหนือหน้าที่ NFR-01..09 | กำหนดครบทุกข้อ พร้อมวิธีทวนสอบในส่วนที่ 5 |
...
|---|---|---|---|
| TBD-01 | ความสอดคล้องระหว่างยอดสต็อกในระบบกับจำนวนสินค้าจริงในคลัง | นับสินค้าจริงในคลังของร้านเทียบกับยอดในระบบ 20 คำสั่งซื้อ | ก่อนสรุปวัตถุประสงค์ข้อ 1.2.3 อย่างสมบูรณ์ |
| TBD-02 | เวลาพิมพ์ใบเสร็จกับเครื่องพิมพ์ความร้อนจริง และตารางรหัสอักขระไทยที่เครื่องรุ่นนั้นรองรับ | ต่อเครื่องพิมพ์จริงที่ร้าน จับเวลา และตรวจว่าภาษาไทยพิมพ์ถูกต้อง | ก่อนสรุป NFR-05 |
...
|---|---|---|---|---|
| AC-01 | ผู้ใช้มีบัญชีที่เปิดใช้งานอยู่ | ผู้ใช้เข้าสู่ระบบด้วยชื่อผู้ใช้และรหัสผ่านที่ถูกต้อง | ได้รับโทเคนที่ระบุบทบาท และเห็นเฉพาะเมนูที่ตรงกับบทบาทของตน | FR-01 |
| AC-02 | ผู้จัดการเปิดหน้าจัดการข้อมูลสินค้า | ผู้จัดการแก้ไขจุดสั่งซื้อเพิ่มของสินค้าหนึ่งรายการ | ค่าที่บันทึกในฐานข้อมูลตรงกับที่กรอก และมีบันทึกในประวัติที่เก็บทั้งค่าเดิมและค่าใหม่ | FR-02 |
| AC-03 | มีสินค้าที่เปิดขายอยู่ในระบบ | พนักงานขายเลือกสินค้าหลายรายการและระบุจำนวน | ยอดรวมที่ระบบคำนวณตรงกับการคำนวณด้วยมือ และรหัส QR ระบุยอดตรงกัน | FR-03 |
| AC-04 | พนักงานขายมีรายการสินค้าพร้อมชำระ | พนักงานกดยืนยันรับชำระเงินติดต่อกันหลายครั้ง | เลขที่คำสั่งซื้อไม่ซ้ำกันทุกรายการ แม้จะบันทึกพร้อมกันจากหลายเครื่อง | FR-03 |
| AC-05 | บริการพิมพ์ใบเสร็จขัดข้องหรือปิดอยู่ | พนักงานกดยืนยันรับชำระเงิน | คำสั่งซื้อยังถูกบันทึกและเข้าคิวคลังตามปกติ พร้อมแจ้งเตือนบนหน้าจอว่าพิมพ์ไม่สำเร็จ | FR-03 |
| AC-06 | พนักงานคลังเปิดหน้าจอคิวค้างไว้โดยไม่แตะหน้าจอ | พนักงานขายยืนยันรับชำระเงินคำสั่งซื้อใหม่ | คำสั่งซื้อปรากฏบนหน้าจอคิวเองภายใน 3 วินาที โดยไม่ต้องกดรีเฟรช | FR-04; NFR-02 |
| AC-07 | คำสั่งซื้อหนึ่งรายการอยู่ในคิวรอจ่าย | พนักงานคลังหลายเครื่องกดยืนยันจ่ายรายการเดียวกันพร้อมกัน | สำเร็จเพียงเครื่องเดียว เครื่องที่เหลือได้รับข้อความว่าคำสั่งซื้อถูกจ่ายไปแล้ว และสต็อกถูกหักเพียงครั้งเดียว | FR-05, FR-06; NFR-04 |
| AC-08 | คำสั่งซื้อมีสินค้ารายการหนึ่งที่จำนวนมากกว่ายอดคงเหลือ | พนักงานคลังกดยืนยันจ่ายสินค้า | ระบบยกเลิกธุรกรรมทั้งหมด สต็อกทุกรายการไม่เปลี่ยนแปลง สถานะคำสั่งซื้อไม่เปลี่ยน และไม่มีบันทึกการเคลื่อนไหว | FR-06 |
| AC-09 | มีคำสั่งซื้อและการจ่ายสินค้าเกิดขึ้นในวันนั้น | ผู้จัดการเปิดแดชบอร์ด | ตัวเลขทุกตัวตรงกับผลรวมที่คำนวณจากฐานข้อมูลโดยตรง | FR-07 |
| AC-10 | สินค้ารายการหนึ่งมียอดคงเหลือใกล้จุดสั่งซื้อเพิ่ม | พนักงานคลังยืนยันจ่ายจนยอดต่ำกว่าจุดสั่งซื้อเพิ่ม | ระบบสร้างการแจ้งเตือนประเภทสต็อกต่ำและแสดงบนหน้าจอผู้จัดการทันที และไม่แจ้งซ้ำถ้ายังไม่ได้อ่าน | FR-08 |
| AC-11 | มีเหตุการณ์เกิดขึ้นในระบบหลายประเภท | ผู้จัดการค้นหาประวัติโดยกรองตามช่วงวันที่และบทบาทผู้กระทำ | ผลลัพธ์ตรงตามเงื่อนไขทุกแถว และมีบันทึกครบทุกประเภทเหตุการณ์สำคัญ | FR-09 |
| AC-12 | ผู้ใช้เข้าสู่ระบบด้วยบทบาทที่ไม่มีสิทธิ์ในส่วนนั้น | ผู้ใช้พยายามเข้าถึงข้อมูลหรือการกระทำที่สงวนไว้ | ระบบปฏิเสธด้วยรหัส 403 และไม่แสดงเมนูของส่วนนั้นตั้งแต่แรก | FR-01; NFR-01 |
| AC-13 | มีคำสั่งซื้อค้างอยู่ในคิวรอจ่ายสินค้าโดยยังไม่มีใครรับไปจัดของ | เวลารอเกินเกณฑ์ที่กำหนดไว้ | ระบบสร้างการแจ้งเตือนประเภทคิวงานค้างนานผิดปกติที่ระบุเลขที่คำสั่งซื้อและระยะเวลาที่รอ | FR-08 |
...
## E.1 Evidence → ความต้องการ → พฤติกรรม → แบบจำลอง

ตารางนี้ไล่จากหลักฐานที่พบหน้างาน ผ่านความต้องการที่กำหนดขึ้นจากหลักฐานนั้น ไปจนถึงพฤติกรรมที่ผู้ใช้เห็นและแบบจำลองที่รองรับ ทุกความต้องการในเอกสารนี้จึงย้อนกลับไปหาปัญหาจริงได้เสมอ

| Evidence | ความต้องการ | พฤติกรรมและเกณฑ์การยอมรับ | แบบจำลอง |
|---|---|---|---|
| EV-01 ไม่มีระบบบันทึกการขายที่เชื่อมกับสต็อก ใช้ใบเสร็จและบิลกระดาษ | FR-03; BR-01 | US-01; UC-03, UC-04; AC-03, AC-04 | M-03 |
| EV-02 ข้อมูลรายการขายกระจัดกระจาย ตรวจสอบย้อนหลังยาก | FR-09 | US-06; UC-10; AC-11 | M-08 |
| EV-03 หน้าร้านกับคลังสินค้าอยู่คนละพื้นที่ ไม่มีช่องทางสื่อสารเรียลไทม์ | FR-04; BR-03 | US-02; UC-05; AC-06 | M-07 |
| EV-04 ลูกค้าต้องถือใบเสร็จเดินไปคลังเอง เกิดคอขวดในชั่วโมงเร่งด่วน | FR-04; BR-03 | US-02; UC-05, UC-06; AC-06 | M-04, M-07 |
| EV-05 พนักงานคลังอ่านใบเสร็จด้วยสายตา จึงหยิบสินค้าผิดประเภทหรือผิดจำนวน | FR-05 | US-03; UC-07; AC-07 | M-04, M-05 |
| EV-06 มีการนำบิลเก่ามาใช้รับของซ้ำ | FR-06; BR-02 | US-03; UC-07; AC-07 | M-04, M-05 |
| EV-07 ยอดสต็อกในบันทึกคลาดเคลื่อนจากจำนวนสินค้าจริง | FR-06; BR-02 | US-03; UC-07; AC-08 | M-05, M-06 |
| EV-08 ผู้จัดการต้องรอสรุปยอดขายและนับสต็อกด้วยมือตอนท้ายวัน | FR-07; BR-04 | US-04; UC-08, UC-09; AC-09 | M-03, M-06 |
| EV-09 การสั่งซื้อสินค้าพึ่งประสบการณ์แทนข้อมูลจริง | FR-02, FR-08; BR-05 | US-05; UC-02, UC-11; AC-02, AC-10 | M-02, M-08 |
...
| 3 | ระบบออกเลขที่คำสั่งซื้อที่ไม่ซ้ำ บันทึกคำสั่งซื้อพร้อมรายการสินค้าในธุรกรรมเดียว สั่งพิมพ์ใบเสร็จ และผลักเหตุการณ์ออกไป | UC-04; FR-03; AC-04 |
...
| 5 | พนักงานคลังทำเครื่องหมายตรวจนับครบทุกรายการแล้วกดยืนยันจ่าย ระบบเปลี่ยนสถานะ หักสต็อก และบันทึกการเคลื่อนไหวในธุรกรรมเดียว | UC-07; FR-05, FR-06; NFR-04; AC-07 |
| 6 | พนักงานอีกคนกดยืนยันจ่ายรายการเดิมพร้อมกัน ระบบปฏิเสธด้วยข้อความว่าคำสั่งซื้อถูกจ่ายไปแล้ว และสต็อกไม่ถูกหักซ้ำ | BR-02; NFR-04; AC-07 |
| 7 | ยอดคงเหลือของปูนซีเมนต์ต่ำกว่าจุดสั่งซื้อเพิ่ม ระบบสร้างการแจ้งเตือนสต็อกต่ำและแสดงบนหน้าจอผู้จัดการทันที | UC-11; FR-08; BR-05; AC-10 |
| 8 | ผู้จัดการเปิดแดชบอร์ดเห็นยอดขายและคิวงานที่คำนวณสดจากฐานข้อมูล และค้นหาประวัติย้อนหลังของคำสั่งซื้อรายการนี้ได้ครบทุกเหตุการณ์ | UC-08, UC-10; FR-07, FR-09; AC-09, AC-11 |
...
> **Release decision**
> ผล QA ด้านเนื้อหา PASS สำหรับ Review Candidate แต่ยังไม่อนุมัติเป็น Baseline จนกว่าจะปิดประเด็นใน Appendix C ที่ระบุว่าต้องปิดก่อน ซึ่งต้องอาศัยการยืนยันจากเจ้าของสถานประกอบการและการทวนสอบที่หน้างานจริง
