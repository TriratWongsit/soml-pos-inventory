...
| รายการ | รายละเอียด |
|---|---|
| Artifact | Use Case SRS v1.0 (จัดวางจากบทที่ 1–4 ของปริญญานิพนธ์) |
| Version | 1.0 |
...
> **เอกสารฉบับนี้ต่างจาก SRS อีกฉบับอย่างไร**
> โครงงานนี้มีเอกสารข้อกำหนดความต้องการสองฉบับที่ใช้คู่กัน ไม่ใช่ฉบับซ้ำซ้อน
>
> | ฉบับ | ไฟล์ | จัดตามมาตรฐาน | จุดเน้น |
> |---|---|---|---|
> | **Use Case SRS** (ฉบับนี้) | `UseCase_SRS_SOML_ENGSE206_v1.0_TH.md` | แบบฟอร์ม IEEE SRS ของรายวิชา ENGSE206 | จัดเนื้อหาตามกรณีการใช้งาน เน้นลำดับขั้นการทำงาน ทางเลือก ข้อยกเว้น เกณฑ์การยอมรับ และการสอบกลับตั้งแต่หลักฐานถึงกรณีทดสอบ |
> | **SRS ตามมาตรฐาน** | `SRS_SOML_SE02_3.md` | ISO/IEC/IEEE 29148 | จัดเนื้อหาตามหมวดของมาตรฐาน เน้นความครบถ้วนของประเภทความต้องการและการทวนสอบรายข้อ |
>
> ทั้งสองฉบับใช้รหัสความต้องการชุดเดียวกัน คือ FR, NFR, BR, UC และ TC จึงอ่านสลับกันได้โดยไม่ต้องแปลงรหัส
...
|---|---|---|---|
| 0.1 | บทที่ 1–2 | รวบรวมปัญหาหน้างาน EV-01..09, Stakeholders และ Constraints | Input |
| 0.2 | บทที่ 3 | เพิ่ม FR/NFR, Use Case UC-01..11, ERD, C4 Model และแผนการทดสอบ | Design Complete |
...
| TC-xx | Test Case ตามแผนการทดสอบในบทที่ 3 |
...
รหัสความต้องการ FR, NFR, BR และ UC ในเอกสารนี้ใช้หมายเลขเดียวกับที่ปรากฏในบทที่ 3 ของปริญญานิพนธ์ทุกประการ เพื่อให้อ้างอิงข้ามเอกสารได้โดยไม่ต้องแปลงรหัส ส่วนรหัส EV, US, AC, M, CON และ TBD เพิ่มขึ้นใหม่ในเอกสารฉบับนี้ตามโครงสร้างของแบบฟอร์ม
...
|---|---|---|
| REF-01 | ENGSE206_CaseX_SRS_v1.0_TH.docx | โครงสร้างหัวข้อหลักของเอกสารฉบับนี้ |
| REF-02 | ปริญญานิพนธ์ SE02 บทที่ 1 | ที่มาของปัญหา EV-01..09 วัตถุประสงค์ และขอบเขต |
| REF-03 | ปริญญานิพนธ์ SE02 บทที่ 2 | ทฤษฎีและงานที่เกี่ยวข้องซึ่งใช้อ้างอิงการออกแบบ |
| REF-04 | ปริญญานิพนธ์ SE02 บทที่ 3 | FR/NFR, UC-01..11, ERD, C4 Model และแผนการทดสอบ |
| REF-05 | ปริญญานิพนธ์ SE02 บทที่ 4 | ผลการทดสอบจริงที่อ้างอิงในเอกสารนี้ |
| REF-06 | `SRS_SOML_SE02_3.md` — SRS ตามมาตรฐาน ISO/IEC/IEEE 29148 | ฉบับคู่กันของโครงงาน ใช้รหัสความต้องการชุดเดียวกัน |
| REF-07 | app/evidence/ | ไฟล์หลักฐานผลการทดสอบที่อ้างอิงทุกตัวเลข |
...
*ภาพที่ 2 — Container View แสดงส่วนที่ติดตั้งแยกจากกันสี่ส่วนและช่องทางสื่อสารระหว่างกัน*
...
| รายการ | ข้อกำหนด |
|---|---|
| ฝั่งผู้ใช้ | เว็บเบราว์เซอร์รุ่นล่าสุด Chrome, Edge หรือ Firefox บนคอมพิวเตอร์ แท็บเล็ต หรือสมาร์ตโฟน |
| ฝั่งเซิร์ฟเวอร์ | Node.js 20 LTS ขึ้นไป · Express.js |
| ฐานข้อมูล | MySQL 8.0 กลไกจัดเก็บ InnoDB |
| อุปกรณ์ต่อพ่วง | เครื่องพิมพ์ใบเสร็จความร้อนที่รองรับ ESC/POS ต่อผ่าน USB หรือเครือข่าย |
| เครือข่าย | เครือข่ายภายในร้านที่ครอบคลุมทั้งจุดชำระเงินและคลังสินค้า |
| ช่องทางเข้าถึง | HTTPS เท่านั้น |
...
| เอกสาร | ผู้ใช้ | เนื้อหา |
|---|---|---|
| คู่มือติดตั้งและใช้งาน (app/README.md) | ผู้ดูแลระบบของร้าน | ขั้นตอนติดตั้งเจ็ดข้อ การตั้งค่าเครื่องพิมพ์ การสาธิต และการทดสอบ |
| ข้อความแนะนำในหน้าจอ | ผู้ใช้ทุกบทบาท | ข้อความกำกับปุ่มที่มีผลถาวร คำเตือนก่อนยืนยันจ่าย และผลลัพธ์ของทุกการกระทำ |
...
หน้าจอที่พัฒนาแล้วมีเก้าหน้า ได้แก่ หน้าเข้าสู่ระบบ หน้าขายหน้าร้าน หน้ารับชำระด้วย QR พร้อมเพย์ หน้าคิวรอจ่ายสินค้า หน้ายืนยันจ่ายสินค้า แดชบอร์ดปฏิบัติการ แดชบอร์ดระดับบริหาร หน้าจัดการข้อมูลสินค้า หน้าการแจ้งเตือน และหน้าประวัติการทำรายการ
...
ส่วนนี้จัดตามเป้าหมายของผู้ใช้และกรณีการใช้งาน ตามที่แบบฟอร์ม IEEE อนุญาต โดยคงรหัสความต้องการเดิมจากบทที่ 3

![แผนภาพกรณีการใช้งานกลุ่มเข้าสู่ระบบ](assets/diagrams/fig3-06_uc_auth.png)

*ภาพที่ 3 — Use Case Diagram กลุ่มการเข้าสู่ระบบและการควบคุมสิทธิ์ (UC-01, UC-02)*

![แผนภาพกรณีการใช้งานกลุ่มพนักงานขาย](assets/diagrams/fig3-07_uc_sales.png)

*ภาพที่ 4 — Use Case Diagram กลุ่มการขายหน้าร้าน (UC-03, UC-04)*

![แผนภาพกรณีการใช้งานกลุ่มคลังสินค้า](assets/diagrams/fig3-08_uc_warehouse.png)

*ภาพที่ 5 — Use Case Diagram กลุ่มคลังสินค้า (UC-05, UC-06, UC-07)*

![แผนภาพกรณีการใช้งานกลุ่มผู้จัดการ](assets/diagrams/fig3-09_uc_manager.png)

*ภาพที่ 6 — Use Case Diagram กลุ่มผู้จัดการ (UC-08, UC-09, UC-10, UC-11)*
...
![แผนภาพลำดับของการยืนยันจ่ายสินค้า](assets/diagrams/fig3-11_seq_uc07.png)

*ภาพที่ 7 — ลำดับการทำงานของการยืนยันจ่ายสินค้าและการตัดสต็อกภายในธุรกรรมเดียว*
...
| ID | ข้อกำหนด | ผลการทวนสอบ |
|---|---|---|
| NFR-01 | ข้อมูลและเมนูต้องจำกัดการเข้าถึงตามบทบาทอย่างเข้มงวด | ผ่านการตรวจ 7 จาก 7 รายการ |

รายละเอียดมาตรการที่ทวนสอบแล้ว

| มาตรการ | ผล |
|---|---|
| เข้าถึงผ่าน HTTPS เท่านั้น การเรียกผ่าน http ถูกส่งต่อไปยัง https | ตอบรหัส 301 ไปยังปลายทาง https |
| ทุกคำขอต้องแนบโทเคน คำขอที่ไม่มีโทเคนถูกปฏิเสธ | ตอบรหัส 401 |
| โทเคนที่ปลอมแปลงถูกปฏิเสธ | ตอบรหัส 401 |
| บทบาทที่ไม่มีสิทธิ์ถูกปฏิเสธ | ตอบรหัส 403 |
| รหัสผ่านเก็บเป็นค่าที่ผ่านการเข้ารหัสแบบ bcrypt ไม่เก็บรหัสผ่านจริง | ตรวจจากโครงสร้างฐานข้อมูล |
| ข้อความเมื่อเข้าสู่ระบบไม่สำเร็จต้องเหมือนกันทุกกรณี ไม่บอกว่าผิดที่ชื่อผู้ใช้หรือรหัสผ่าน | ข้อความตรงกันทั้งสองกรณี |
| หมายเลขพร้อมเพย์จริงและรหัสผ่านฐานข้อมูลต้องไม่ถูกเก็บลงที่เก็บโค้ด | ตรวจแล้วไม่พบในไฟล์ใด รวมถึงตรวจรหัส QR ในภาพหน้าจอทุกภาพ |
...
**กฎเพิ่มเติมที่บังคับใช้ในระบบ**

| กฎ | รายละเอียด |
|---|---|
| การเปลี่ยนสถานะคำสั่งซื้อ | เปลี่ยนได้เฉพาะเส้นทางที่แผนภาพสถานะอนุญาต และเปลี่ยนเป็นส่งมอบสำเร็จได้เฉพาะผ่านธุรกรรมตัดสต็อก |
| การยกเลิกคำสั่งซื้อ | เป็นสิทธิ์ของผู้จัดการเท่านั้น |
| การกำหนดราคา | ราคาที่ใช้คำนวณต้องอ่านจากฐานข้อมูลเสมอ ไม่รับค่าที่ส่งมาจากหน้าจอ |
| เลขที่คำสั่งซื้อ | ต้องไม่ซ้ำ โดยฐานข้อมูลเป็นผู้รับประกันขั้นสุดท้าย |
...
*ภาพที่ 8 — Order Lifecycle Model แสดงสถานะทั้งสี่และเส้นทางการเปลี่ยนสถานะที่ระบบอนุญาต*
...
*ภาพที่ 9 — โครงสร้างเชิงตรรกะของผู้ใช้งาน สินค้า คำสั่งซื้อ รายการสินค้า การเคลื่อนไหวสต็อก การแจ้งเตือน และประวัติการทำรายการ*
...
แผนภาพประกอบอื่นของแบบจำลองเหล่านี้อยู่ในบทที่ 3 ของปริญญานิพนธ์ ได้แก่ แผนภาพส่วนประกอบภายในระบบหลังบ้าน แผนภาพลำดับของการสร้างคำสั่งซื้อ และแผนภาพกิจกรรมของกระบวนการทั้งหมด
...
## E.4 Requirement → Verification Result

| ID | ความต้องการ | Use Case | Test Case | ผลการทดสอบ |
|---|---|---|---|---|
| FR-01 | เข้าสู่ระบบและควบคุมสิทธิ์ตามบทบาท | UC-01 | TC-01 | ผ่าน |
| FR-02 | จัดการข้อมูลสินค้าและจุดสั่งซื้อเพิ่ม | UC-02 | TC-02 | ผ่าน |
| FR-03 | สร้างคำสั่งซื้อ รับชำระ และออกใบเสร็จ | UC-03, UC-04 | TC-03, TC-04, TC-13 | ผ่าน |
| FR-04 | คิวรอจ่ายสินค้าแบบเรียลไทม์ | UC-05, UC-06 | TC-05 | ผ่าน |
| FR-05 | ยืนยันจ่ายสินค้า | UC-07 | TC-06 | ผ่าน |
| FR-06 | ตัดสต็อกแบบอะตอมมิก | UC-07 | TC-07, TC-08 | ผ่านบางส่วน รอ TC-07 |
| FR-07 | แดชบอร์ดปฏิบัติการและระดับบริหาร | UC-08, UC-09 | TC-09 | ผ่าน |
| FR-08 | แจ้งเตือนภายในแอปพลิเคชัน | UC-11 | TC-10, TC-11 | ผ่าน |
| FR-09 | บันทึกและค้นหาประวัติการทำรายการ | UC-10 | TC-12 | ผ่าน |
| NFR-01 | ความมั่นคงปลอดภัยและ RBAC | ทุก UC | TC-01 | ผ่าน 7 จาก 7 รายการ |
| NFR-02 | ข้อมูลปรากฏบนหน้าจอคิวภายใน 3 วินาที | UC-05 | TC-05 | ผ่าน สูงสุด 9 ms |
| NFR-03 | รองรับแท็บเล็ตและสมาร์ตโฟน | UC-05, UC-07 | ตรวจด้วยเบราว์เซอร์จริง | ผ่าน |
| NFR-04 | ทนทานต่อธุรกรรมพร้อมกัน | UC-07 | TC-06, TC-08 | ผ่าน 300 คำขอ |
| NFR-05 | พิมพ์ใบเสร็จภายใน 5 วินาที | UC-03 | TC-13 | ผ่านบางส่วน วัดในโหมดจำลอง |
| NFR-06 | รองรับพร้อมกันไม่น้อยกว่า 10 เซสชัน | ทุก UC | TC-14 | ผ่าน ไม่มีคำขอล้มเหลว |
| NFR-07 | ทำงานถูกต้องบนเบราว์เซอร์ที่กำหนด | ทุก UC | เมทริกซ์เบราว์เซอร์ | ผ่านทั้งสามกลไกเรนเดอร์ |
| NFR-08 | แยกชั้นและแยกส่วนประกอบตามที่ออกแบบ | — | ตรวจโครงสร้างซอร์สโค้ด | ผ่าน |
| NFR-09 | ติดตั้งซ้ำได้ด้วยเอกสารเพียงอย่างเดียว | — | ติดตั้งตามคู่มือ | ผ่านบางส่วน รอผู้ทวนสอบภายนอก |
...
| แผนภาพประกอบครบตามที่ต้นแบบกำหนด | PASS | ภาพที่ 1–9 ครอบคลุมบริบท คอนเทนเนอร์ กรณีการใช้งานสี่กลุ่ม ลำดับการจ่ายสินค้า วงจรชีวิตคำสั่งซื้อ และแบบจำลองข้อมูล |
...
| รหัสความต้องการตรงกับบทที่ 3 ของปริญญานิพนธ์ | PASS | ใช้หมายเลข FR, NFR, BR, UC, TC ชุดเดียวกันโดยไม่แปลงรหัส |
