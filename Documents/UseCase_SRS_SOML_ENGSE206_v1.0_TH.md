...
*ภาพที่ 2 — Use Case Diagram กลุ่มการเข้าสู่ระบบและการควบคุมสิทธิ์ (UC-01, UC-02)*

![แผนภาพกรณีการใช้งานกลุ่มพนักงานขาย](assets/diagrams/fig3-07_uc_sales.png)

*ภาพที่ 3 — Use Case Diagram กลุ่มการขายหน้าร้าน (UC-03, UC-04)*

![แผนภาพกรณีการใช้งานกลุ่มคลังสินค้า](assets/diagrams/fig3-08_uc_warehouse.png)

*ภาพที่ 4 — Use Case Diagram กลุ่มคลังสินค้า (UC-05, UC-06, UC-07)*

![แผนภาพกรณีการใช้งานกลุ่มผู้จัดการ](assets/diagrams/fig3-09_uc_manager.png)

*ภาพที่ 5 — Use Case Diagram กลุ่มผู้จัดการ (UC-08, UC-09, UC-10, UC-11)*
...
*ภาพที่ 6 — Order Lifecycle Model แสดงสถานะทั้งสี่และเส้นทางการเปลี่ยนสถานะที่ระบบอนุญาต*
...
*ภาพที่ 7 — โครงสร้างเชิงตรรกะของผู้ใช้งาน สินค้า คำสั่งซื้อ รายการสินค้า การเคลื่อนไหวสต็อก การแจ้งเตือน และประวัติการทำรายการ*
...
| แผนภาพประกอบครบตามช่องที่ต้นแบบกำหนด | PASS | ภาพที่ 1–7 คือแผนภาพบริบท กรณีการใช้งานสี่กลุ่ม วงจรชีวิตคำสั่งซื้อ และแบบจำลองข้อมูล |
